      ...
      <ul className="nav flex-column">
        ...
        {usuarios && (
          <>
            ...
            <Link className="nav-link text-white" to={usuarios.Ruta}>
              <i className="bi bi-grid"></i> {usuarios.Nombre}
            </Link>
          </>
        )}
        ...
        {centros && (
          <>
            ...
            <Link className="nav-link text-white" to={centros.Ruta}>
              <i className="bi bi-grid"></i> {centros.Nombre}
            </Link>
          </>
        )}

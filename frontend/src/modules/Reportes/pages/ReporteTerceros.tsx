                ...
                <div className="card-body">
                    <form onSubmit={buscarReporte} className="row g-3 mb-4">
                        ...
                        <div className="col-md-1 d-flex align-items-end">
                            <button type="submit" className="btn btn-dark btn-sm w-100 fw-bold">Buscar</button>
                        </div>

                        <div className="col-12 mt-2">
                            <button type="button" onClick={limpiarFiltros} className="btn btn-link btn-sm text-decoration-none p-0 text-muted">
